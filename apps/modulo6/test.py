...
class Modulo6AccessTest(TestCase):
    def setUp(self):
        # Preparamos datos de prueba
        self.client = Client()
        self.group = Group.objects.create(name='Módulo6')
    ...
    def test_redirect_if_not_logged_in(self):
        resp = self.client.get(reverse('mod6_dashboard'))
        self.assertRedirects(resp, reverse('mod6_login') + '?next=' + reverse('mod6_dashboard'))
