...
class Modulo1AccessTest(TestCase):
    def setUp(self):
        # Preparamos datos de prueba
        self.client = Client()
        self.group = Group.objects.create(name='Módulo1')
    ...
    def test_redirect_if_not_logged_in(self):
        resp = self.client.get(reverse('mod1_dashboard'))
        self.assertRedirects(resp, reverse('mod1_login') + '?next=' + reverse('mod1_dashboard'))
