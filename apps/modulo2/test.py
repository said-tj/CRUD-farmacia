...
class Modulo2AccessTest(TestCase):
    def setUp(self):
        # Preparamos datos de prueba
        self.client = Client()
        self.group = Group.objects.create(name='Módulo2')
    ...
    def test_redirect_if_not_logged_in(self):
        resp = self.client.get(reverse('mod2_dashboard'))
        self.assertRedirects(resp, reverse('mod2_login') + '?next=' + reverse('mod2_dashboard'))
