...
class Modulo7AccessTest(TestCase):
    def setUp(self):
        # Preparamos datos de prueba
        self.client = Client()
        self.group = Group.objects.create(name='Módulo7')
    ...
    def test_redirect_if_not_logged_in(self):
        resp = self.client.get(reverse('mod7_dashboard'))
        self.assertRedirects(resp, reverse('mod7_login') + '?next=' + reverse('mod7_dashboard'))
